...
/***/ function(module, exports, __webpack_require__) {
	...
	exports.getBackgroundClassnameFromProps = getBackgroundClassnameFromProps;
	...
	function getBackgroundClassnameFromProps(props) {
	  var classNames = [];
	  ...
	  if (props.fixed) classNames.push(styles.fixed);
	  if (props.className) classNames.push(props.className);
	
	  return classNames.join(' ');
	}
	
	function getBackgroundImageStyle(props) {
	  var bgImageStyle = 'url("' + props.imagePath + '")';
	  if (props.darken) bgImageStyle = 'linear-gradient(rgba(0, 0, 0, ' + props.darken + '), rgba(0, 0, 0, ' + props.darken + ')), ' + bgImageStyle;
	  return bgImageStyle;
	}
...
/***/ function(module, exports) {
	...
	module.exports = {"fullScreen":"Background_fullScreen","scaleToRelative":"Background_scaleToRelative","noRepeat":"Background_noRepeat","cover":"Background_cover","center":"Background_center","fixed":"Background_fixed"};
