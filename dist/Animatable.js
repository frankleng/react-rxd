...
/***/ function(module, exports, __webpack_require__) {
	...
	exports.Keyframes = _Keyframes3.default; /**
...
/***/ function(module, exports, __webpack_require__) {
	...
	var AnimatableKeyframes = function AnimatableKeyframes(props) {
	  ...
	  return React.createElement(
	    'div',
	    {
	      className: classnames((_classnames = {}, _defineProperty(_classnames, styles[props.keyframeClass], props.shouldAnimate), _defineProperty(_classnames, props.className, props.className), _classnames))
	    },
	    props.children
	  );
	};
	
	AnimatableKeyframes.shouldComponentUpdate = function () {
	  return true;
	};
